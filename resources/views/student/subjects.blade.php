    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <form class="form-inline " method="GET" action="{{ route('student.subjects.index') }}">
          <div class="input-group input-group-sm">
            ...
            <div class="input-group-append">
              ...
              <a class="btn btn-navbar" href="{{ route('student.subjects.index') }}">
                    ...
                    <div class="card elevation-3">
                      ...
                      <h5 class="card-title">{{ $subject->subject_name }}</h5>
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('student.materials.index', $subject->id) }}" class="btn btn-primary">View Subject</a>
                        </div>
                    </div>
                </div>
            @endforeach
