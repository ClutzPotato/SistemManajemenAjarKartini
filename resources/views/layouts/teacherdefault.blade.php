  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 bgimage1">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <a href="{{ route('teacher.account') }}" class="d-block">
              @if (auth()->check())
                        <div>
                        {{ auth()->user()->name }} 
                        </div>
...
<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="{{ url('teacher/dashboard') }}" class="nav-link {{ Request::is('teacher/dashboard') ? 'activegreen' : '' }}">
        ...
        <li class="nav-item">
            <a href="{{ url('teacher/classes') }}" class="nav-link {{ Request::is('teacher/classes*') ? 'activegreen' : '' }}">
        ...
        <li class="nav-item">
            <a href="{{ url('teacher/subjects') }}" class="nav-link {{ Request::is('teacher/subjects*') ? 'activegreen' : '' }}">
...
<!-- /.sidebar-menu -->
  ...
  <div class="content-wrapper grad2">
