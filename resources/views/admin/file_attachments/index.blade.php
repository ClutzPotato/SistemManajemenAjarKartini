...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">File Attachments</h1>
            </div><!-- /.col -->
...
<div class="content">
    <div class="container-fluid">
                        ...
                        <table id="example" class="table table-bordered mt-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $attachment->material_id }}</td>
                                    <td>{{ $attachment->material->title }}</td>
                                    <td>{{ $attachment->material->subject->subject_name }}</td>
                                    <td><a href="{{ asset('storage/' . $attachment->file_path) }}" target="_blank">{{ $attachment->file_name }}</a></td>
                                    <td>
                                        <form action="{{ route('file_attachments.destroy', $attachment->attachment_id ) }}" method="POST"
        ...
        <!-- Include Modals -->
        @include('admin.file_attachments.attachments_modals')
    </div>
</div>
